"""
GRPO training script for BrickGPT.
Uses vLLM colocate mode + DeepSpeed ZeRO-2 on 4x H100 GPUs.
...
INIT_MODEL_PATH = os.getenv(
    "INIT_MODEL_PATH",
    MODEL_NAME or "finetuned_models/qwen35_sft_full_ft_run1_causallm",
)
DATASET_DIR = os.getenv("DATASET_DIR", "datasets_pc")
OUTPUT_DIR = os.getenv("OUTPUT_DIR", "/data/cxu26/finetuned_models/qwen_pc_grpo")
RUN_NAME = os.getenv("RUN_NAME", "brickgpt-grpo-vllm-colocate")
...
def main():
    ...
    grpo_config = GRPOConfig(
        ...
        # vLLM colocate: each GPU runs both training and vLLM generation
        use_vllm=True,
        vllm_mode="colocate",
        ...
        # Training — effective batch = 2 * 4 * 4 GPUs = 32
